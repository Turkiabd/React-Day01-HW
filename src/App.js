import "./App.css";
import CatPics from "./Cat";

function App() {
  return (
    // must all of the work under the parent div
    ...
    <div className="App">
      ...
      <div className="catPics">
        <div>
          ...
          <CatPics
            catPic={
              "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIYbtPwK2iyqz9ogEhtruIAuuXI4cN1uyHv3svgv-dOxl-tXY6yqU69FVavHtmlShOBB0&usqp=CAU"
            }
            catName={"toby"}
            catAge={"9 months"}
          />
